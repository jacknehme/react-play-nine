...
var possibleCombinationSum = function(arr, n) {
    ...
    switch(props.answerIsCorrect){
      ...
      case false:
           button = <button className="btn btn-danger">
              ...
              break;
        default:
        button = <button className="btn btn-primary" onClick={props.checkAnswer}
  ...
  class Game extends React.Component { 
    ...
    static initializSize = () => ({
      ...
      state = Game.initializSize();
    resetGame = () => this.setState(Game.initializSize());
